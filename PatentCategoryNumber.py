	...
	steps = {
		...
		"db": {
			...
			'fields': [{
				...
				'name': 'RegionID',
				'reference': { 'fields': ['CurrentAddress', 'PatentApplicant'], 'match': 'address' }
			}, {
